package com.ale.myapp.repository;
...
import com.ale.myapp.config.audit.AuditEventConverter;
import com.ale.myapp.domain.PersistentAuditEvent;
...
import static com.ale.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
